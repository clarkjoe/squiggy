...
(define OGRESS_VIEW 340)
(define OGRESS_COOK_VIEW 341)
(define OGRESS_CATCH_ROSELLA_VIEW 342)
(define OGRESS_CARRY_ROSELLA_VIEW 343)
(define OGRESS_PREP_PIE_A_VIEW 344)
(define OGRESS_PREP_PIE_B_VIEW 345)
(define OGRESS_CARRY_PIE_VIEW 346)
(define OGRESS_COOK_PIE_VIEW 347)
(define OGRESS_KNIFE_VIEW 350)
...
(define OGRESS_STIR_LOOP 0)
(define OGRESS_KNEAD_LOOP 1)
(define OGRESS_CHOP_LOOP 2)